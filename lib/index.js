...
let print = [new SyntaxTree.While(false, new SyntaxTree.Print("Hello, World!!!", 10, true,  null, [1, 2, 3], new SyntaxTree.Add(10, 20)), new SyntaxTree.Print("Else!"))]
print[0].program.sep = '\t'
print[0].elseProgram.sep = '\t'
