...
// let program = [new SyntaxTree.Function('a', new SyntaxTree.For(new SyntaxTree.SetVariable('i', 0), new SyntaxTree.LesserThan(new SyntaxTree.Variable('i'), 10), new SyntaxTree.ExecuteValue(new SyntaxTree.Increase(new SyntaxTree.Variable('i'), true)), new SyntaxTree.Print(new SyntaxTree.Variable('i'))), 'a'), new SyntaxTree.ExecuteValue(new SyntaxTree.CallFunction('a', 10))]
